import wirelessHeadphones from "../Images/Wireless Headphones.jpg";
import smartWatch from "../Images/Smart Watch.jpg";
import gamingKeyboard from "../Images/Gaming Keyboard.jpg";
import laptopBackpack from "../Images/Laptop Backpack.jpg";
import bluetoothSpeaker from "../Images/Bluetooth Speaker.jpg";
import wirelessMouse from "../Images/Wireless Mouse.jpg";
import gamingHeadset from "../Images/headset.jpg";
import usbCHub from "../Images/USB-C Hub.jpg";
...
{/* Page Header */} <div className="mb-8"> <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">
Products </h1>
